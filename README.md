...
### Creditos:
*  Este script foi editado e traduzido com base no script original de SULAIMAN L, disponível em seu GitHub em https://github.com/fisabiliyusri/Mantap.
*  Com o devido crédito a SULAIMAN L, este script foi adaptado para atender a requisitos específicos e inclui tradução para facilitar o acesso e uso por um público mais amplo.
